...
public final class Grade7UpdateController implements Initializable,StudentProvider{
    ...
    private Grade7Controller grade7Controller;
    ...
    public void updateStudent(ActionEvent event) throws IOException,ClassNotFoundException,SQLException
    {
        if(ValidatorData.anynull(
            ...
            DialogUtil.showConfirmation(
                ...
                ()->{
                    stage.close();
                    grade7Controller.refreshTableAfterUpdate();
                });
            return;
        }
        ...
        if (ValidatorData.isvalidatedAge(studentprovider.getAge()) && ValidatorData.isvalidatedYearLevel(studentprovider.getYearlevel())) {
            ...
            obj.updateData(maincontroller.getClicked());
            
            DialogUtil.showConfirmation(
                "SUCCESS",
                "Student with id -> " + studentprovider.getId() + " updated succesfully",
                "/images/check.png",
                ()->{
                    stage.close();
                    grade7Controller.refreshTableAfterUpdate();
    ...
    public void setGrade7Controller(Grade7Controller grade7Controller){
        this.grade7Controller = grade7Controller;
    }
