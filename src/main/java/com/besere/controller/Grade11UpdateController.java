...
public class Grade11UpdateController implements Initializable,StudentProvider{
    ...
    private Grade11Controller grade11Controller;
    ...
    public void updateStudent(ActionEvent event) throws IOException,ClassNotFoundException,SQLException
    {
        if(ValidatorData.anynull(
            ...
            DialogUtil.showConfirmation(
                ...
                ()->{
                    stage.close();
                    grade11Controller.refreshTableAfterUpdate();
                });
    ...
    public void setGrade11Controller(Grade11Controller grade11Controller){
        this.grade11Controller = grade11Controller;
    }
