...
public final class Grade8UpdateController implements Initializable,StudentProvider{
    ...
    private Grade8Controller grade8Controller;
    ...
    public void updateStudent(ActionEvent event) throws IOException,ClassNotFoundException,SQLException
    {
        if(ValidatorData.anynull(
            ...
            DialogUtil.showConfirmation(
                ...
                ()->{
                    stage.close();
                    grade8Controller.refreshTableAfterUpdate();
                });
    ...
    public void setGrade8Controller(Grade8Controller grade8Controller){
        this.grade8Controller = grade8Controller;
    }
