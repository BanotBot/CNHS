...
public class Grade9UpdateController implements Initializable,StudentProvider{
    ...
    private Grade9Controller grade9Controller;
    ...
    public void updateStudent(ActionEvent event) throws IOException,ClassNotFoundException,SQLException
    {
        if(ValidatorData.anynull(
            ...
            DialogUtil.showConfirmation(
                ...
                ()->{
                    stage.close();
                    grade9Controller.refreshTableAfterUpdate();
                });
    ...
    public void setGrade9Controller(Grade9Controller grade9Controller){
        this.grade9Controller = grade9Controller;
    }
