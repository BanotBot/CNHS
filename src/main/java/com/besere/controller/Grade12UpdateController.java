...
public class Grade12UpdateController implements Initializable,StudentProvider{
    ...
    private Grade12Controller grade12Controller;
    ...
    public void updateStudent(ActionEvent event) throws IOException,ClassNotFoundException,SQLException
    {
        if(ValidatorData.anynull(
            ...
            DialogUtil.showConfirmation(
                ...
                ()->{
                    stage.close();
                    grade12Controller.refreshTableAfterUpdate();
                });
    ...
    public void setGrade12Controller(Grade12Controller grade12Controller){
        this.grade12Controller = grade12Controller;
    }
