...
import com.besere.controller.Grade8Controller;
...
public class grade8loader {
    private MainController mainCont;

    public void load8Content(Parent parentload){

        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/grade8.fxml"));
            try {
                parentload = loader.load();
                Grade8Controller refreshData = loader.getController();
    ...
    public void setgrade8loader(MainController mainCont) {
